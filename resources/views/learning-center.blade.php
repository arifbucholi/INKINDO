    ...
    <section class="hero-bg-polos">
        ...
        <div class="hero-content-2">
            <div class="text-content-2">
                ...
                <p>Inkindo menawarkan dua jenis layanan utama: Konstruksi dan Non-Konstruksi. Masing-masing layanan dikelompokkan secara khusus untuk memenuhi kebutuhan Anda, dengan penjelasan detail di bawah ini.
                </p>
            </div>
        </div>
    </section>
