                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="mb-4 pb-2">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link primary-hover-bg" href="./index.html"
                                aria-expanded="false">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-4">
                                                            <img src="../admin/images/profile/user1.jpg"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-4">
                                                            <img src="../admin/images/profile/user2.jpg"
                                                                width="50" class="rounded-circle"
                                                                alt="" />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-4">
                                                            <img src="../admin/images/profile/user3.jpg"
                                                                width="50" class="rounded-circle"
                                                                alt="" />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-4">
                                                            <img src="../admin/images/profile/user4.jpg"
                                                                width="50" class="rounded-circle"
                                                                alt="" />
                                                        </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <ul class="list-unstyled d-flex align-items-center mb-0">
                                        <li><a class="me-1" href="javascript:void(0)"><i
                                                    class="ti ti-star-filled text-warning"></i></a></li>
                                        <li><a class="me-1" href="javascript:void(0)"><i
                                                    class="ti ti-star-filled text-warning"></i></a></li>
                                        <li><a class="me-1" href="javascript:void(0)"><i
                                                    class="ti ti-star-filled text-warning"></i></a></li>
