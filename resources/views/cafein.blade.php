        ...
        <section class="lc-learning-center">
            <div class="lc-card">
                <div class="lc-card-header">
                    ...
                    <div class="lc-info">
                        <h2>CafeIN</h2>
                        <p class="lc-category">Aplikasi Mobile</p>
                        <p class="lc-description">
                            Aplikasi Android yang dikembangkan oleh Inkindo Jawa Timur ini berfungsi sebagai sarana
                            pelayanan, peningkatan kapasitas, dan ruang interaksi bagi anggota serta stakeholder terkait
                            pembangunan berkelanjutan dan pengembangan sumber daya manusia dan organisasi.
                        </p>
                        <div class="lc-rating">
                ...
                <div class="lc-card-body">
                    <h3>Apa Itu Aplikasi CafeIN ?</h3>
                    <p>CafeIN adalah aplikasi dari Inkindo Jawa Timur yang menyediakan informasi dan wadah interaksi
                        bagi anggota dan masyarakat terkait pembangunan di berbagai sektor, seperti prasarana, sosial,
                        ekonomi, budaya, dan lingkungan berkelanjutan. Platform ini mempertemukan stakeholder
                        pembangunan, termasuk pemerintah, penyedia jasa, rantai pasok, industri, akademisi, dan
                        masyarakat. CafeIN dirancang sebagai ruang belajar, berbagi, dan aktualisasi, serta membuka
                        peluang kolaborasi guna menciptakan kehidupan masyarakat yang lebih baik, bermartabat, dan
                        berkelanjutan.</p>

                    <h4>Kelebihan Website Learning Center</h4>
                    <ul>
                        <li>
                            Aplikasi CafeIN dikembangkan sesuai standar terbaru Google untuk pengembangan dinamis di
                            masa depan.
                        </li>
                        <li>
                            CafeIN adalah sistem terpadu yang dirancang berdasarkan kebutuhan stakeholder industri
                            konstruksi dan nonkonstruksi.

                        </li>
                        <li>
                            CafeIN berbasis komunitas, menyediakan ruang interaksi online dan offline bagi pengguna.

                        </li>
                        <li>
                            Mendukung riset dan pengembangan berkelanjutan sesuai kebutuhan pengguna.
